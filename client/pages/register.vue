            ...
            <div class="w-full h-100">
              ...
              focus:bg-white focus:outline-none" required>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="password" name="confirmpassword" id="" placeholder="Enter Password" minlength="6"
              ...
              focus:bg-white focus:outline-none" required>
                    ...
                    <NuxtLink to="/"><button type="submit" name="submit" class="w-full block bg-black hover:bg-gray-500 focus:bg-gray-400 text-white font-semibold rounded-lg
            px-4 py-3 mt-6">Register</button></NuxtLink>
                </form>
                ...
                <p class="mt-8">Have an account? <a href="login.php"
                        class="text-blue-500 hover:text-blue-700 font-semibold">Log in Here!</a></p>
